...
if ($_SESSION[$guid]["systemSettingsSet"]==FALSE) {
	...
	<html class="no-js" lang="en">
	    ...
	    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
			...
			<script type="text/javascript" src="<?php print $_SESSION[$guid]["absoluteURL"] ?>/lib/jquery/jquery.min.js"></script>

			<link rel="stylesheet" href="<?php print $_SESSION[$guid]["absoluteURL"] ?>/lib/zurb-foundation-6/css/foundation.css"></link>
		...
		<body>
			...
			<script type="text/javascript" src="<?php print $_SESSION[$guid]["absoluteURL"] ?>/lib/zurb-foundation-6/js/foundation.js"></script>
			<script type="text/javascript" src="<?php print $_SESSION[$guid]["absoluteURL"] ?>/lib/zurb-foundation-6/js/vendor/what-input.min.js"></script>
